...
class MainBody extends StatefulWidget {
  ...
  MainBody({required this.pageType, required this.bodyWidth});
...
class _MainBodyState extends State<MainBody> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    switch (widget.pageType) {
      case MAIN_PAGE_TYPE.BEACH:
        _bgColor = COLOR_BEACH;
        _waveColor = COLOR_SEA;
        break;
      case MAIN_PAGE_TYPE.SEA:
        _bgColor = COLOR_SEA;
  ...
  Widget build(BuildContext context) {
    int waveCount = 30;
    final double waveSize = widget.bodyWidth / (waveCount);
